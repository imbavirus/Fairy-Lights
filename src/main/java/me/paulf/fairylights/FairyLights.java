...
public final class FairyLights {
        ...
        public static final ResourceLocation CONNECTION_TYPE = ResourceLocation.fromNamespaceAndPath(ID,
                        "connection_type");
        ...
        public static final Object NETWORK = new NetBuilder(ResourceLocation.fromNamespaceAndPath(ID, "net"))
                        ...
                        .consumer(() -> new UpdateEntityFastenerMessage.Handler())
                        .clientbound(OpenEditLetteredConnectionScreenMessage::new)
                        .consumer(() -> new OpenEditLetteredConnectionScreenMessage.Handler())
        ...
        public FairyLights(final IEventBus modEventBus) {
                ...
                modEventBus.addListener((RegisterPayloadHandlersEvent event) -> {
                        ...
                        registrar.playToClient(
                                        ...
                                        OpenEditLetteredConnectionScreenMessage::handle);
