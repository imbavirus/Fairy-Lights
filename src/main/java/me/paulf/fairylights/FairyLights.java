...
public final class FairyLights {
    ...
    public static final Object NETWORK = new NetBuilder(ResourceLocation.fromNamespaceAndPath(ID, "net"))
            ...
            .consumer(() -> (msg, ctx) -> {
                if (net.neoforged.fml.loading.FMLEnvironment.dist.isClient()) {
                    me.paulf.fairylights.client.net.ClientMessageHandlers.handleJingle((JingleMessage) msg, ctx);
                }
            })
            .clientbound(() -> new UpdateEntityFastenerMessage(0, new net.minecraft.nbt.CompoundTag()))
            .consumer(() -> (msg, ctx) -> {
                if (net.neoforged.fml.loading.FMLEnvironment.dist.isClient()) {
                    me.paulf.fairylights.client.net.ClientMessageHandlers.handleUpdateEntityFastener((UpdateEntityFastenerMessage) msg, ctx);
                }
            })
            .clientbound(OpenEditLetteredConnectionScreenMessage::new)
            .consumer(() -> (msg, ctx) -> {
                if (net.neoforged.fml.loading.FMLEnvironment.dist.isClient()) {
                    me.paulf.fairylights.client.net.ClientMessageHandlers.handleOpenScreen((OpenEditLetteredConnectionScreenMessage) msg, ctx);
                }
            })
    ...
    public FairyLights(final IEventBus modEventBus) {
        ...
        me.paulf.fairylights.server.item.FLDataComponents.REG.register(bus);
        ...
        if (net.neoforged.fml.loading.FMLEnvironment.dist.isClient()) {
            try {
                proxy = (ServerProxy) Class.forName("me.paulf.fairylights.client.ClientProxy").getDeclaredConstructor().newInstance();
            } catch (Exception e) {
        ...
        modEventBus.addListener((RegisterPayloadHandlersEvent event) -> {
            ...
            registrar.playToClient(
                    ...
                    (msg, ctx) -> {
                        if (net.neoforged.fml.loading.FMLEnvironment.dist.isClient()) {
                            me.paulf.fairylights.client.net.ClientMessageHandlers.handleUpdateEntityFastener(msg, new me.paulf.fairylights.server.net.ClientMessageContext(ctx));
                        }
                    });
            ...
            registrar.playToClient(
                    ...
                    (msg, ctx) -> {
                         if (net.neoforged.fml.loading.FMLEnvironment.dist.isClient()) {
                             me.paulf.fairylights.client.net.ClientMessageHandlers.handleOpenScreen(msg, new me.paulf.fairylights.server.net.ClientMessageContext(ctx));
                         }
                    });
