...
import za.co.infernos.fairylights.server.fastener.CollectFastenersEvent;
...
public final class ClientEventHandler {
    ...
    private static String getComponentDescription(final HitResult result) {
        ...
        final boolean isCord = result.intersection.getFeatureType() == za.co.infernos.fairylights.server.connection.Connection.CORD_FEATURE;
    ...
    public static void updateHitConnection() {
        ...
        if (mc.hitResult != null && mc.level != null && viewer != null) {
            ...
            if (mc.hitResult instanceof net.minecraft.world.phys.BlockHitResult blockHit) {
                ...
                if (blockState.getBlock() == za.co.infernos.fairylights.server.block.FLBlocks.FASTENER.get()) {
