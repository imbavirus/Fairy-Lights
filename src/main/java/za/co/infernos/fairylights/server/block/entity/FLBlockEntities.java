...
public final class FLBlockEntities {
    ...
    // In 1.21.2, BlockEntityType.Builder was removed. Use direct constructor instead.
    public static final DeferredHolder<BlockEntityType<?>,BlockEntityType<FastenerBlockEntity>> FASTENER = REG.register("fastener",
        () -> new BlockEntityType<>(FastenerBlockEntity::new, Set.of(FLBlocks.FASTENER.get())));

    public static final DeferredHolder<BlockEntityType<?>,BlockEntityType<LightBlockEntity>> LIGHT = REG.register("light",
        () -> new BlockEntityType<>(LightBlockEntity::new, Set.of(
